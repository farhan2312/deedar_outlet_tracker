...
export function createUser(input: {
  ...
  return queryOne<UserRow>(
    `insert into users (name, phone, password_hash, head_quarter, depots, role)
     values ($1, $2, $3, $4, $5, $6)
     returning *`,
    [
      input.name,
...
export function adminCreateUser(input: {
  ...
  return queryOne<UserRow>(
    `insert into users (name, phone, password_hash, head_quarter, depots, role, reports_to_id, status, must_change_password)
